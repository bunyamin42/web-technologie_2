...
<body>
    ...
    <h2 style="margin-top: 5%;margin-bottom: 25px; text-align: center;">Matching-Profile: Entdecke Freunde, die zu dir passen</h2>
...
// Funktion zur Verarbeitung der JSON-Daten, um alle Benutzerinformationen auszugegeben als ein div Tag
function verarbeiteJsonDaten(jsonData) {
    ...
    for (var i = 0; i < freundendaten.length; i++) {
        ...
        friendItem.innerHTML = '<div class="row"><div class="col-1" style="margin-right: 4%;"><img src="' + friendProfilePic + '" alt="' + friendUsername + '\'s Profilbild" class="rounded-circle"></div><div class="col d-flex align-items-center justify-content-between"><div><b>' + friendUsername + '</b></div><div style="margin-left: 10px;"><b>' + friendinformation + '</b></div></div> <i class="fa-solid fa-user-plus"></i> <a href="/Projekt%20FitBook/Web-Technologie-Projektarbeit%20-%20Kopie%20(2)/php_dateien/profile.php?user_id=' + encodeURIComponent(friendId) + '" title="Userprofil" style="margin-right: 10px;" class="fa-solid fa-user"></a></div>';
